...
const Header = () => {
  ...
  return (
    <header
      ...
      className={` w-full z-10 transition-all duration-300 "bg-[#F2F2F2] bg-opacity-10"
      } backdrop-filter backdrop-blur-lg shadow-md`}
    >
      <nav
        aria-label="Global"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <p className="-mx-3 block rounded-lg px-3 py-2 text-center text-base font-semibold leading-7 text-white hover:bg-gray-50 hover:text-black">
                  PROJECTS
                </p>
              </div>
            </div>
